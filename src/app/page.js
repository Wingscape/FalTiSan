        ...
        <div className="grid grid-cols-1 min-[600px]:grid-cols-2 min-[1160px]:grid-cols-4 gap-x-8">
            {
                projects?.map((project) => {
                    return (
                        <article key={project.id} className="bg-white p-6">
                            <h4 className="text-faltisan-darkblue">{project.category}</h4>
                            <h3 className="text-[24px] min-[600px]:text-[32px] font-bold leading-tight mb-3">{project.title}</h3>
                            <p className={`${bitterFont.className} leading-tight mb-[23px]`}>{project.description}</p>
                            <a href={project.url} className="transition-color ease-in-out duration-300 inline-block border-2 border-faltisan-mediumblue text-faltisan-mediumblue hover:bg-faltisan-mediumblue hover:text-white py-[11px] px-[23px]">See more!</a>
                        </article>
                    );
                })
            }
        ...
        <main>
            <header className="grid grid-cols-1 min-[1160px]:grid-cols-2 gap-x-10 h-dvh min-h-[730px] px-[36px] min-[600px]:px-[72px] pb-[102px] pt-[174px]">
                <section>
                    ...
                    <Link href="#contact" className="transition-color ease-in-out duration-300 inline-block bg-faltisan-mediumblue hover:bg-faltisan-lightblue hover:text-black active:bg-faltisan-darkblue text-[20px] min-[1330px]:text-[28px] text-white py-4 px-12">Contact me!</Link>
                </section>
            ...
            <section id="about" className="grid grid-cols-1 min-[1160px]:grid-cols-2 mb-10">
                ...
                <section className="grid content-center px-[32px] min-[600px]:pr-[136px] min-[600px]:pl-[64px] py-10 text-[16px] min-[375px]:text-[20px] min-[1330px]:text-2xl">
                    <div>
                        ...
                        <Link href="#contact" className="flex flex-row group w-fit">
            ...
            <section id="portfolio" className="bg-[#EEEEEE] px-[36px] min-[600px]:px-[72px] pt-[48px] pb-[40px]">
                <h2 className="text-[32px] min-[600px]:text-[40px] min-[1330px]:text-[48px] pb-[40px] font-bold leading-tight text-center">Portfolio</h2>
                <Portfolio />
            </section>
            <section id="contact" className="px-[36px] min-[600px]:px-[72px] pt-[48px] pb-[58px] text-[16px] min-[375px]:text-[20px] min-[600px]:text-[24px]">
